...
def main() -> None:
    ...
    doc_vectors = build_embeddings([doc["text"] for doc in CORPUS], "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    query_vectors = build_embeddings([query.query for query in QUERIES], "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    rows = []
