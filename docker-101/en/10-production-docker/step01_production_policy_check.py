...
def run() -> dict[str, object]:
    runtime_flags = ["--read-only", "--cap-drop=ALL", "--security-opt=no-new-privileges", "--user=1000:1000"]
    ...
    return {"success": len(missing) == 0 and has_semver and has_sha, "missing_flags": missing, "tags": tags}
